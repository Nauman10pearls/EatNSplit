...
export default function App() {
  ...
  function handleSelection(frined) {
    ...
    setSelectedFriend((cur) => (cur?.id === frined.id ? null : frined));
    setshowAddFriend(false);
  }
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  const [whoIsaying, setWhoIsaying] = useState("user");
  ...
  function handleSubmit(e) {
    ...
    onSplitBill(whoIsaying === "user" ? paidByFriend : -paidByUser);
  }
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <select
        value={whoIsaying}
        onChange={(e) => setWhoIsaying(e.target.value)}
      >
